...
-- Sorunlar çözüldü: Database ismi, sıralama, trigger/view problemleri
-- ===============================================
...
-- ===============================================
-- 1. TEMEL TABLOLAR (DEPENDENCY YOK)
-- ===============================================
...
CREATE INDEX IX_orders_marketplace_order_id ON orders(marketplace, marketplace_order_id);
...
WHERE permission_key IN (
    ...
    'marketplaces.view', 'marketplaces.manage'
);
...
VALUES (
    ...
    '$2a$12$LQv3c1yqBw.uuKzAiKKFaO0vkY.bCwqJFB5QgLgFp/FZfI2YQfQ.K',
    (SELECT id FROM user_roles WHERE role_name = 'admin'),
    1
);
