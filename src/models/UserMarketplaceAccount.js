...
console.log(
  "UserMarketplaceAccount - SUPPORTED_MARKETPLACES:",
      ...
      marketplace: {
        ...
        validate: {
          ...
          customValidator(value) {
            console.log(
              "UserMarketplaceAccount validation - marketplace value:",
              value
            );
            console.log(
              "UserMarketplaceAccount validation - allowed values:",
              SUPPORTED_MARKETPLACES
            );
            if (!SUPPORTED_MARKETPLACES.includes(value)) {
              throw new Error(
                `Invalid marketplace: ${value}. Allowed: ${SUPPORTED_MARKETPLACES.join(", ")}`
              );
            }
          },
        },
...
const associateUserMarketplaceAccount = () => {
  ...
  const UserMarketplaceCredentials =
    require("./UserMarketplaceCredentials").UserMarketplaceCredentials;
  const UserMarketplaceSettings =
    require("./UserMarketplaceSettings").UserMarketplaceSettings;
