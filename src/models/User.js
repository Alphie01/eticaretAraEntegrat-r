...
class User extends Model {
  ...
  async matchPassword(enteredPassword) {
    ...
    if (
      (this.oauth_provider && this.oauth_provider !== "local") ||
      !this.password_hash
    ) {
      return false;
    }
  ...
  User.init(
    {
      ...
      companyID: {
        type: DataTypes.INTEGER,
        allowNull: true,
        field: 'company_id'  // DB'deki gerçek kolon ismi ne ise onu yaz
      },
    },
    {
      sequelize,
...
const associateUser = () => {
  ...
  User.belongsTo(UserCompany, {
    foreignKey: "company_id",
    as: "company", // alias olarak 'company' kullanacağız
  });
